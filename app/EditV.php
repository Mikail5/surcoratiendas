...
<body>
      ...
      <div id="conpad">
        ...
        <div class="menpad">
          ...
          <div id="contener">
            <h3>Revisar información de ventas</h3>
            <div>
                ...
                while($consu=mysqli_fetch_array($res))
                {
                  ...
                  <thead>
                    <tr>
                      ...
                      <td class=\"celic\"><a class=\"btnver\" href=\"detaVen.php?venta=$ide\">Ver&nbsp;detalles</td>
                    </tr>
                  </thead>";
                  $exis++;
                }
